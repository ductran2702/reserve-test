...
import { findAllPossibleReservation, reserve } from './reserve'
...
describe('reserve HOTEL3', () => {
  ...
  test('reserve 17 HOTEL3', () => {
    expect(reserve(17, HOTEL3)).toEqual('Double Double Double DoublePremium DoublePremium DoublePremium Family Single - $460')
  })
  ...
  test('reserve 19 HOTEL3', () => {
    expect(reserve(19, HOTEL3)).toEqual('Double Double Double DoublePremium Family Penthouse Single Single - $530')
  })
  test('reserve 20 HOTEL3', () => {
    expect(reserve(20, HOTEL3)).toEqual('Double Double Double DoublePremium DoublePremium Family Penthouse Single - $565')
  })
  test('reserve 21 HOTEL3', () => {
    expect(reserve(21, HOTEL3)).toEqual('Double Double Double DoublePremium DoublePremium Family Penthouse Single Single - $595')
  })
  test('reserve 22 HOTEL3', () => {
    expect(reserve(22, HOTEL3)).toEqual('Double Double Double DoublePremium DoublePremium DoublePremium Family Penthouse Single - $630')
  })
  test('reserve 23 HOTEL3', () => {
    expect(reserve(23, HOTEL3)).toEqual('Double Double Double DoublePremium DoublePremium DoublePremium Family Penthouse Single Single - $660')
  })
  test('reserve 24 HOTEL3', () => {
    expect(reserve(24, HOTEL3)).toEqual('Double Double Double DoublePremium DoublePremium DoublePremium Family Penthouse Premium Single Single - $705')
  })
  test('reserve 25 HOTEL3', () => {
    expect(reserve(25, HOTEL3)).toEqual('Double Double Double DoublePremium DoublePremium DoublePremium Family Penthouse Premium Premium Single Single - $750')
  })
  test('reserve 26 HOTEL3', () => {
    expect(reserve(26, HOTEL3)).toEqual('Double Double Double DoublePremium DoublePremium DoublePremium Family Penthouse Premium Premium Premium Single Single - $795')
  })
  test('reserve 27 HOTEL3', () => {
    expect(reserve(27, HOTEL3)).toEqual('No option')
  })
})
